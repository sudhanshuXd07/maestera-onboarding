      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        <AnimatePresence mode="wait">
          {submitted ? (
            ...
            <motion.div key="intro" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}>
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
                ...
                <div className="p-6 flex items-center justify-between">
                  ...
                  <button className="px-6 py-2.5 rounded-xl text-white" style={{ backgroundColor: brand.black }} onClick={() => setStep(1)}>
                    Continue
                  </button>
                </div>
              </div>
            ...
            <motion.div key="multi" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}>
